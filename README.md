...
- `derived/figure_data/`: machine-readable data or definitions underlying Figures 1–6.
- `scripts/reproduce_results.py`: recomputes aggregate results and table/figure payloads.
- `scripts/reproduce_figures.py`: regenerates six stand-alone figures into a local `outputs/` directory.
